<div id="main-wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-page-view fl" style="width: 950px;margin: auto;"><br />
            <br /><a href="<?php echo base_url();?>admin/createInvoice" style="background: #fff; border: 1px solid #333; padding: 5px; text-decoration: none;">Create an Invoice</a><br /><br />
                   <br />
        ...
        <br />
            ...
            <div style='width: 90%; margin-top: 50px;'>
                ...
                <div style='width: 40%; height: 110px; float: left; margin-left: 20px;'><b>For  Students:</b>
                    <div  style='border: 1px solid #aaa; padding: 5px; max-height: 100px; overflow-y: auto;'>
                        <?php
...
<script><!--
    ...
    function getInvoices(id, type)
    {
        ...
        if (type == 1) 
        { 
            url = "<?php echo base_url('admin_base/studentInvoices') ?>";
            dat = { noTutorID: '1', theTime: theTime, student_id: id, DatesJSON: DatesJSON };
            // dat = { tutorID: <?php echo $tutors[0]->tutor_ID; ?>, tutorUse: 1, theTime: theTime, student_id: id, DatesJSON: DatesJSON };
        }
        else if (type == 2)
        {
           url  = "<?php echo base_url('admin_base/tutorinvoices') ?>";
           dat  = { noStudentID: '1', theTime: theTime, tutor_id: id, DatesJSON: DatesJSON  };
        }
        var request = $.ajax({
                             url    : url,
                             type   : "POST",
          ...
          var url_2  = "<?php echo base_url('tutors/studentDates') ?>";
            var request = $.ajax({
                             ...
                             success: function(msg){  //alert(msg); 
                               ...
                               totalMSG += "<p>"+ msg.countStudents +" Students, $"+ msg.sumInvoices+" Invoiced, $"+ msg.sumPaid +" Paid, "+ msg.countRecur +" Recurring, "+ msg.countFlex +" Flex Time, "+msg.quantUnpaid+" Unpaid</p>";
                        ...
                        request.fail(function(jqXHR, textStatus){ alert( JSON.stringify(jqXHR));
